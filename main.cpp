...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "QUAR-seeder\n"
...
static const string mainnet_seeds[] = {"206.189.26.208", ""};
static const string testnet_seeds[] = {"206.189.26.208",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 18989), true);
  }
  do {
